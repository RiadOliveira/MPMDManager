...
for FILE in "${FILES[@]}"; do
  mpicc -I"$INCLUDE_DIR" -o "$OUTPUT_DIR/$FILE.out" "$SCRIPT_DIR/abstraction/filenameHandler.c" "$SCRIPT_DIR/abstraction/utils.c" "$SCRIPT_DIR/abstraction/mpmdManager.c" "$SCRIPT_DIR/example/message.c" "$OUTPUT_DIR/$FILE.c"
done
